...
** TODO [#A] Missing Python Packages: google-auth-oauthlib  google-api-python-client
...
** TODO /bisos/venv/py3/dev-bisos3/bin/pip install
...
| [[Phase-2]]  | 2025-01-19 | ---        | 1 wks | Planned | Cleanup: Fully eliminate icm&unisos Regression test |
| [[Phase-3]]  |            |            | 1 wks | Planned | Station NAT DHCP WiFi in Site in Permanent VMs      |
...
*** TODO Add Concept of Capability Phase -- UnsitedPhase/RawBisos, Vs SitedPhase Vs FreshDebian
*** TODO Add FreshDebianCaps as a Phase in vagrant file with  [[MiniBisos]]  and [[Cap:bisos.facter]]
*** TODO Capture concept of Bx Objects - BPOs, BxRepoObjects (BRO), BxInputObjects (BIO), BxForeignObjects(BFOs)
...
*** ----------------  MML
*** TODO MML Integration in Blee:: https://github.com/karthink/gptel?tab=readme-ov-file  https://github.com/freckletonj/uniteai
*** TODO MML Integration in Blee:: https://github.com/copilot-emacs/copilot.el https://github.com/alan-w-255/tabby.el?tab=readme-ov-file
*** TODO MML Integration in Blee:: Create a Panel for Blee MML
*** -----------------
