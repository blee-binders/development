...
*** TODO atexit.register(print,"Exiting Python Script!") -- https://www.geeksforgeeks.org/detect-script-exit-in-python/
...
*** TODO @atexit.register module.plant of seeded scripts
...
*** TODO Re-do generic guest build using .153 as registrar
*** TODO Create a  /dedicated VM/ for registrars. Start from sysCharRealize.sh
*** TODO Add reg capability to  dedicated VM.
