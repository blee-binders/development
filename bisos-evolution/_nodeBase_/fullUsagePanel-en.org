...
####+END
** +
** TODO [#A] [[file:/bisos/core/raw/rebuild/AI-WorkPlan.org]] --- Adapt Containers to Guest and Box
SCHEDULED: <2026-08-31 Mon>
Revisit raw-bisos genesis picture and show layerings and types. (mention sysCbmManage.cs)
** WAITING [#A]  Use Marmee to send out messages to FV
SCHEDULED: <2026-09-03 Thu>
Create mailings for Linkedin posts
...
Move platformLimits.cs to bisos.platform
