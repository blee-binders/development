...
** <<Phase-2>> Next Steps
*** +
*** DONE IMPORTANT VERIFY: In sysIdentity set run platformBasesUpdate.cs --PROBLEM. Look at the logfiles
*** sudo -u bisos /bisos/venv/py3/bisos3/bin/pip3 install --no-cache-dir --force-reinstall --upgrade bisos.py3-all
...
*** +
*** TODO in pip install editable, get rid of warning
*** ------------
*** TODO Convert fileTreeManage.py of unisos to fileTreeManage.cs
*** ---
*** TODO Convert and test py2cs for cryptKeyring now in bisos.crypt
*** TODO Convert and test py2cs for symCrypt now in bisos.crypt
*** ---
...
** TODO [#A]  pip install python-magic -- ModuleNotFoundError: No module named 'magic' --
** -
...
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/qqq
