...
####+END
** +
** Now that there is startAiActivity.cs Each pkg and repo has its own WorkPlan. Link to those from here.
** -
** TODO [#A] Create a "Relevant Info" top panel. Categorize by topic.
SCHEDULED: <2026-08-04 Tue>
Example: RelevantInfo/AI/noChatbot   Then from AI, link to Relevant Info.
