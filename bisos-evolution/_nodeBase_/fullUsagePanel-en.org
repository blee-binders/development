...
####+END
** +
** TODO Web UI -- csPlayer for rawBisos
- bro_rawBisosPlatform/sys/bin Is the strating point . Put cap from bisos.webCap there.
- bxRepos/bisos-web --- Add to common/bases
- bxRepos/cliGui
- bisos.webCap
** TODO [#A] Add sbomsList to sbom-seed.py
...
** TODO [#A] [AtHome] At "By* is about autonomy oriented redecentralization ..."
